...
class TorcsEnv:
    ...
    def step(self, step, client, u, early_stop):
        ...
        '''
        self.time_step += 1
        return obs, reward, client.R.d['meta'], {}
        # return reward

    def reset(self, client, relaunch=False, reset=True):
        #print("Reset")
        port = client.port
        self.time_step = 0
        # print '111'
        ...
        client = snakeoil3.Client(p=port, vision=self.vision, reset=reset)  # Open new UDP in vtorcs
