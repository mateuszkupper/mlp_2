...
class Client(object):
    def __init__(self,H=None,p=None,i=None,e=None,t=None,s=None,d=None,vision=False,reset=True):
        ...
        if reset:
          ...
          self.setup_connection_no_reset()
            ...
            try:
                ...
                if n_fail < 0:
                    ...
                    if self.vision is False:
                        os.system(u'torcs -nofuel -nodamage -nolaptime -p ' + str(self.port) + ' &')
                    else:
    ...
    def setup_connection_no_reset(self):
        # == Set Up UDP Socket ==
        try:
            self.so= socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
        except socket.error as emsg:
